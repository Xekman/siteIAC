...
class BigBlueButton {
	...
	private $_bbbServerBaseUrl_inner;			
	...
	*/
		...
		$this->_bbbServerBaseUrl_inner 	= CONFIG_SERVER_BASE_URL_INNER;
		$this->_bbbServerBaseUrl_outer 	= CONFIG_SERVER_BASE_URL_OUTER;		
	}
	...
	*/
	...
	public function getCreateMeetingUrl($creationParams) {
		...
		*/
		...
		$creationUrl = $this->_bbbServerBaseUrl_inner."api/create?";
		// Add params:
		$params = 
	...
	public function getJoinMeetingURL($joinParams) {
		...
		*/
		...
		$joinUrl = $this->_bbbServerBaseUrl_outer."api/join?";
	...
	public function getEndMeetingURL($endParams) {
		...
		*/
		...
		$endUrl = $this->_bbbServerBaseUrl_inner."api/end?";
		$params = 
		'meetingID='.urlencode($this->_meetingId).
		'&password='.urlencode($this->_password);
	...
	*/
	...
	public function getIsMeetingRunningUrl($meetingId) {
		...
		*/
		...
		$runningUrl = $this->_bbbServerBaseUrl_inner."api/isMeetingRunning?";
		$params = 
		'meetingID='.urlencode($this->_meetingId);
	...
	public function getGetMeetingsUrl() {
		...
		*/
		$getMeetingsUrl = $this->_bbbServerBaseUrl_inner."api/getMeetings?checksum=".sha1("getMeetings".$this->_securitySalt);
	...
	public function getMeetingInfoUrl($infoParams) {
		...
		*/
		...
		$infoUrl = $this->_bbbServerBaseUrl_inner."api/getMeetingInfo?";
		$params = 
		'meetingID='.urlencode($this->_meetingId).
		'&password='.urlencode($this->_password);
	...
	*/
	...
	public function getRecordingsUrl($recordingParams) {
		...
		*/
		$recordingsUrl = $this->_bbbServerBaseUrl_inner."api/getRecordings?";
		$params = 
	...
	public function getPublishRecordingsUrl($recordingParams) {
		...
		*/
		$recordingsUrl = $this->_bbbServerBaseUrl_inner."api/publishRecordings?";
		$params = 
	...
	public function getDeleteRecordingsUrl($recordingParams) {
		...
		*/
		$recordingsUrl = $this->_bbbServerBaseUrl_inner."api/deleteRecordings?";
		$params = 
		'recordID='.urlencode($recordingParams['recordId']);
